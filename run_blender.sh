export CAD_PATH=$PWD/Data/real_data/teacup_mesh/teacup.obj    # path to a given cad model(mm)
...
export OUTPUT_DIR=$PWD/Data/real_data/teacup_mesh/teacup_tmp        # path to a pre-defined file for saving results
