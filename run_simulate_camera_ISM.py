...
def capture_and_process(sam2_checkpoint, model_cfg, cad_path, sam_tmp_dir, data_dir, track_vis_dir, mask_vis_dir, track_pose_path, segmentor_model, stability_score_thresh, use_ref, rounds):
    # 制定相机临时存放地
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", default=f"Data/real_data/data_real/{task}/episode_{time}", help="rgb, depth and mask")
